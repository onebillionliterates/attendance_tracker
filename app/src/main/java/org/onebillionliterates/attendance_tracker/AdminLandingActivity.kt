...
class AdminLandingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val icons = listOf(R.string.fa_school_solid, R.string.fa_clipboard_list_solid, R.string.fa_chalkboard_teacher_solid, R.string.fa_chart_area_solid)
        ...
        findViewById<View>(R.id.schools).setOnClickListener { view ->
            val intent = Intent(this, SchoolListingActivity::class.java)
            startActivity(intent)
        }

        findViewById<View>(R.id.teachers).setOnClickListener { view ->
            val intent = Intent(this, TeachersActivity::class.java)
            startActivity(intent)
        }

        findViewById<View>(R.id.sessions).setOnClickListener { view ->
